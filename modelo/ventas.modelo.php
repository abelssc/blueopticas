<?php
    ...
    class ModeloVentas{
        ...
        public static function mdlgetVentas(){
            $db=crearConeccion();
            $query="SELECT v.id,v.fecha_recojo,v.hora_recojo,s.situacion,u.usuario,c.cliente,acuenta,preciototal,(preciototal-IFNULL(acuenta,0)) as debe,v.registro from ventas v 

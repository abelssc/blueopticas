...
<body class="hold-transition sidebar-mini sidebar-collapse <?php  if(!estaAutenticado()) echo 'login-page'?> ">
    ...
    if(estaAutenticado()){
      ...
      echo '<div class="wrapper">';
        ...
        $rutas=["inicio","usuarios","categorias","productos","clientes","administrar-ventas","crear-ventas","reporte-ventas","editar-venta","info-venta","reporte-pagos","caja","gastos","salir"];
        if(isset($_GET["ruta"])){
